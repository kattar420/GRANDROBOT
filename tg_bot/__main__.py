...
TECHNO_IMG = "https://telegra.ph/file/cc4a575d5abf4ec92c03c.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/✮☬ A̶ղƓЄԼ☬✮")],
                                                                                   [InlineKeyboardButton(text="ADD MISS SWEETY BOT TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/pradiator/GRANDROBOT")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("Hola,😘apki sewa mai hazir hu")
